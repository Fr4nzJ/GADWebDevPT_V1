...
@section('title', 'Create Dashboard Statistic - GAD Admin Panel')

@section('content')
<div class="container">
    <div class="row mb-4">
        <div class="col-md-12">
            <h1 class="title is-3">Create Statistic Card</h1>
        </div>
    </div>
    ...
    <div class="box">
        <form method="POST" action="{{ route('admin.dashboard-statistics.store') }}">
            @csrf
                    ...
                    <div class="field">
                        ...
                        <div class="control">
                            <input class="input @error('label') is-danger @enderror" type="text" name="label" 
                                   value="{{ old('label') }}" placeholder="News Posts" required>
                        </div>
                        @error('label')
                    ...
                    <div class="field">
                        ...
                        <div class="control">
                            <input class="input @error('value') is-danger @enderror" type="number" name="value" 
                                   value="{{ old('value') }}" placeholder="48" required min="0">
                        </div>
                        @error('value')
                            <p class="help is-danger">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="field">
                        ...
                        <div class="control">
                            <div class="select @error('color_class') is-danger @enderror">
                                <select name="color_class" value="{{ old('color_class', 'blue') }}">
                                    <option value="blue" {{ old('color_class') === 'blue' ? 'selected' : '' }}>Blue</option>
                                    <option value="purple" {{ old('color_class') === 'purple' ? 'selected' : '' }}>Purple</option>
                                    <option value="green" {{ old('color_class') === 'green' ? 'selected' : '' }}>Green</option>
                                    <option value="orange" {{ old('color_class') === 'orange' ? 'selected' : '' }}>Orange</option>
                                    <option value="red" {{ old('color_class') === 'red' ? 'selected' : '' }}>Red</option>
                                </select>
                            </div>
                        </div>
                        @error('color_class')
                    ...
                    <div class="field">
                        ...
                        <div class="control">
                            <input class="input @error('icon_class') is-danger @enderror" type="text" name="icon_class" 
                                   value="{{ old('icon_class', 'fas fa-chart-bar') }}" placeholder="fas fa-chart-bar">
                        </div>
                        @error('icon_class')
                            <p class="help is-danger">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="field">
                        ...
                        <div class="control">
                            <input class="input @error('trend_value') is-danger @enderror" type="number" name="trend_value" 
                                   value="{{ old('trend_value') }}" placeholder="12">
                        </div>
                        @error('trend_value')
                            <p class="help is-danger">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="field">
                        ...
                        <div class="control">
                            <div class="select @error('trend_direction') is-danger @enderror">
                                <select name="trend_direction" value="{{ old('trend_direction', 'up') }}">
                                    <option value="up" {{ old('trend_direction') === 'up' ? 'selected' : '' }}>Up</option>
                                    <option value="down" {{ old('trend_direction') === 'down' ? 'selected' : '' }}>Down</option>
                                    <option value="flat" {{ old('trend_direction') === 'flat' ? 'selected' : '' }}>Flat</option>
                                </select>
                            </div>
                        </div>
            ...
            <div class="field">
                ...
                <div class="control">
                    <input class="input @error('trend_text') is-danger @enderror" type="text" name="trend_text" 
                           value="{{ old('trend_text') }}" placeholder="12 this month">
                </div>
                @error('trend_text')
                    <p class="help is-danger">{{ $message }}</p>
                @enderror

                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input @error('title') is-danger @enderror" type="text" name="title" 
                            placeholder="e.g., Gender-Responsive Research Toolkit" value="{{ old('title') }}" required>
                    </div>
                    @error('title')
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <textarea class="textarea @error('description') is-danger @enderror" name="description" 
                            placeholder="Resource description" rows="4" required>{{ old('description') }}</textarea>
                    </div>
                    @error('description')
                        <p class="help is-danger">{{ $message }}</p>
                    @enderror
                        ...
                        <div class="field">
                            ...
                            <div class="control">
                                <input class="input @error('icon') is-danger @enderror" type="text" name="icon" 
                                    placeholder="e.g., fas fa-book" value="{{ old('icon') }}">
                            </div>
                            @error('icon')
                                <p class="help is-danger">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="field">
                            ...
                            <div class="control">
                                <input class="input @error('color') is-danger @enderror" type="text" name="color" 
                                    placeholder="e.g., #667eea" value="{{ old('color') }}">
                            </div>
                            @error('color')
                                <p class="help is-danger">{{ $message }}</p>
                            @enderror
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input @error('button_text') is-danger @enderror" type="text" name="button_text" 
                            placeholder="e.g., Download Toolkit" value="{{ old('button_text', 'View Resource') }}" required>
                    </div>
                    @error('button_text')
                        <p class="help is-danger">{{ $message }}</p>
                    @enderror
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input @error('button_url') is-danger @enderror" type="text" name="button_url" 
                            placeholder="https://example.com/resource.pdf" value="{{ old('button_url') }}">
                    </div>
                    @error('button_url')
                        <p class="help is-danger">{{ $message }}</p>
                    @enderror
                    ...
                    <div class="control">
                        <div class="select @error('button_action') is-danger @enderror is-fullwidth">
                            <select name="button_action" required>
                                <option value="download" @if(old('button_action') == 'download') selected @endif>Download</option>
                                <option value="access" @if(old('button_action') == 'access') selected @endif>Access</option>
                                <option value="view" @if(old('button_action') == 'view') selected @endif>View</option>
                                <option value="link" @if(old('button_action') == 'link') selected @endif>External Link</option>
                            </select>
                        </div>
                    </div>
                    @error('button_action')

...
@section('title', 'Edit Monthly Event Chart Data - GAD Admin Panel')

@section('content')
<!-- ===== PAGE HEADER ===== -->
<div class="page-header">
    <h1 class="page-title">Edit Monthly Event Chart Data Point</h1>
</div>
...
<div class="card" style="background: white; border-radius: 12px; padding: 2rem; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.08); color: #333;">
    ...
    <form action="{{ route('admin.monthly-event-charts.update', $monthlyEventChart->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="field">
            ...
            <div class="control">
                <input class="input" type="number" name="value" min="0" value="{{ $monthlyEventChart->value }}" required>
            </div>
            @error('value')
                <p class="help is-danger">{{ $message }}</p>
            @enderror
        ...
        <div class="field">
            ...
            <div class="control">
                <input class="input" type="number" name="order" min="1" value="{{ $monthlyEventChart->order }}" required>
            </div>
        ...
        <div class="field">
            <div class="control">
                <label class="checkbox">
                    <input type="checkbox" name="is_active" value="1" {{ $monthlyEventChart->is_active ? 'checked' : '' }}>

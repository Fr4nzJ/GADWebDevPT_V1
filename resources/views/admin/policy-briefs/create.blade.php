...
@section('title', 'Add Policy Brief')

@section('content')
<div class="container mt-5">
    <div class="columns is-centered">
        <div class="column is-three-quarters">
            <h1 class="title">Add New Policy Brief</h1>
            ...
            <form action="{{ route('admin.policy-briefs.store') }}" method="POST">
                @csrf
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input @error('title') is-danger @enderror" type="text" name="title" 
                            placeholder="e.g., Only 1 in 4 Women Agricultural Workers..." value="{{ old('title') }}" required>
                    </div>
                    @error('title')
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <textarea class="textarea @error('description') is-danger @enderror" name="description" 
                            placeholder="Brief summary of the policy brief" rows="4" required>{{ old('description') }}</textarea>
                    </div>
                    @error('description')
                        <p class="help is-danger">{{ $message }}</p>
                    @enderror
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input @error('pages') is-danger @enderror" type="number" name="pages" 
                            placeholder="0" value="{{ old('pages', 0) }}" min="0">
                    </div>
                    @error('pages')
                        <p class="help is-danger">{{ $message }}</p>
                    @enderror
                        ...
                        <div class="field">
                            ...
                            <div class="control">
                                <input class="input @error('year') is-danger @enderror" type="text" name="year" 
                                    placeholder="e.g., 2024" value="{{ old('year') }}" pattern="\d{4}">
                            </div>
                            @error('year')
                                <p class="help is-danger">{{ $message }}</p>
                            @enderror
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input @error('icon') is-danger @enderror" type="text" name="icon" 
                            placeholder="e.g., fas fa-file-alt" value="{{ old('icon') }}">
                    </div>

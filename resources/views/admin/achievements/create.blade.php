...
@section('title', 'Add Key Achievement')

@section('content')
<div class="container mt-5">
    <div class="columns is-centered">
        <div class="column is-three-quarters">
            <h1 class="title">Add New Achievement</h1>
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input @error('number') is-danger @enderror" type="text" name="number" 
                            placeholder="e.g., 250+, 8.5K" value="{{ old('number') }}" required>
                    </div>
                    @error('number')
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input @error('label') is-danger @enderror" type="text" name="label" 
                            placeholder="e.g., Agencies with Gender Focal Persons" value="{{ old('label') }}" required>
                    </div>
                    @error('label')
                        <p class="help is-danger">{{ $message }}</p>
                    @enderror
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input @error('icon') is-danger @enderror" type="text" name="icon" 
                            placeholder="e.g., fas fa-users, fas fa-chart-bar" value="{{ old('icon') }}">
                    </div>

...
@section('title', 'Edit Program - GAD Admin Panel')
        ...
        <div class="columns">
            <div class="column is-12">
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input" type="text" name="title" value="{{ old('title', $program->title) }}" placeholder="Enter program title" required>
                    </div>
                    @error('title')
                    ...
                    <div class="control">
                        <div class="select is-fullwidth">
                            <select name="category" required>
                                ...
                                <option value="women_empowerment" {{ old('category', $program->category) === 'women_empowerment' ? 'selected' : '' }}>Women Empowerment</option>
                                <option value="education" {{ old('category', $program->category) === 'education' ? 'selected' : '' }}>Education & Skills</option>
                                <option value="safety" {{ old('category', $program->category) === 'safety' ? 'selected' : '' }}>Safety & Protection</option>
                                <option value="leadership" {{ old('category', $program->category) === 'leadership' ? 'selected' : '' }}>Leadership</option>
                                <option value="lgbtq" {{ old('category', $program->category) === 'lgbtq' ? 'selected' : '' }}>LGBTQ+ Rights</option>
                                <option value="mainstreaming" {{ old('category', $program->category) === 'mainstreaming' ? 'selected' : '' }}>Mainstreaming</option>
                            </select>
                        </div>
                    </div>
                    @error('category')
                    ...
                    <div class="control">
                        <div class="select is-fullwidth">
                            <select name="status" required>
                                ...
                                <option value="suspended" {{ old('status', $program->status) === 'suspended' ? 'selected' : '' }}>Suspended</option>
                            </select>
                        </div>
                    </div>
                    @error('status')
        ...
        <div class="columns">
            <div class="column is-6-tablet is-6-desktop">
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input" type="date" name="start_date" value="{{ old('start_date', $program->start_date->format('Y-m-d')) }}" required>
                    </div>
                    @error('start_date')
                    <p class="help is-danger">{{ $message }}</p>
                    @enderror
            ...
            <div class="column is-6-tablet is-6-desktop">
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input" type="date" name="end_date" value="{{ old('end_date', $program->end_date ? $program->end_date->format('Y-m-d') : '') }}">
                    </div>
                    @error('end_date')
                    <p class="help is-danger">{{ $message }}</p>
                    @enderror
        ...
        <div class="columns">
            <div class="column is-6-tablet is-6-desktop">
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input" type="number" name="beneficiaries" value="{{ old('beneficiaries', $program->beneficiaries) }}" min="0">
                    </div>
                    @error('beneficiaries')
                    <p class="help is-danger">{{ $message }}</p>
                    @enderror
            ...
            <div class="column is-6-tablet is-6-desktop">
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input" type="number" name="budget" value="{{ old('budget', $program->budget) }}" min="0">
                    </div>
                    @error('budget')
                    <p class="help is-danger">{{ $message }}</p>
                    @enderror
        ...
        <div class="columns">
            <div class="column is-12">
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input" type="text" name="location" value="{{ old('location', $program->location) }}" placeholder="Enter program location">
                    </div>
                    @error('location')
                    <p class="help is-danger">{{ $message }}</p>
                    @enderror
        ...
        <div class="columns">
            <div class="column is-12">
                <div class="field">
                    ...
                    <div class="control">
                        <textarea class="textarea" name="description" rows="6" placeholder="Enter detailed program description" required>{{ old('description', $program->description) }}</textarea>
                    </div>
                    @error('description')
                    <p class="help is-danger">{{ $message }}</p>
                    @enderror
        ...
        <div class="columns">
            <div class="column is-12">
                <div class="field">
                    ...
                    <div class="control">
                        <textarea class="textarea" name="target_group" rows="4" placeholder="Describe the target beneficiaries">{{ old('target_group', $program->target_group) }}</textarea>
                    </div>
                    @error('target_group')
                    <p class="help is-danger">{{ $message }}</p>
                    @enderror
        ...
        <div class="columns">
            <div class="column is-12">
                <div class="field">
                    ...
                    <div class="control">
                        <textarea class="textarea" name="objectives" rows="5" placeholder="Enter program objectives, one per line">{{ old('objectives', $program->objectives ? implode("\n", $program->objectives) : '') }}</textarea>
                    </div>
                    @error('objectives')
                    <p class="help is-danger">{{ $message }}</p>
                    @enderror

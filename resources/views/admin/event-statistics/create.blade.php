...
@section('title', 'Add Event Statistic')

@section('content')
<div class="container mt-5">
    <div class="columns is-centered">
        <div class="column is-three-quarters">
            <h1 class="title">Add New Event Statistic</h1>
            ...
            <form action="{{ route('admin.event-statistics.store') }}" method="POST">
                @csrf
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input @error('label') is-danger @enderror" type="text" name="label" 
                            placeholder="e.g., Total Events, Expected Attendees" value="{{ old('label') }}" required>
                    </div>
                    @error('label')
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input @error('value') is-danger @enderror" type="text" name="value" 
                            placeholder="e.g., 35, 15K+, ₱25M" value="{{ old('value') }}" required>
                    </div>
                    @error('value')
                        <p class="help is-danger">{{ $message }}</p>
                    @enderror
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input @error('icon') is-danger @enderror" type="text" name="icon" 
                            placeholder="e.g., fas fa-calendar-alt, fas fa-users" value="{{ old('icon') }}">
                    </div>
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input @error('color') is-danger @enderror" type="text" name="color" 
                            placeholder="e.g., #667eea, #764ba2" value="{{ old('color') }}">
                    </div>
                    @error('color')
                        <p class="help is-danger">{{ $message }}</p>
                    @enderror

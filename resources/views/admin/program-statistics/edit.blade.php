...
@section('title', 'Edit Program Statistic')

@section('content')
<div class="container mt-5">
    <div class="columns is-centered">
        <div class="column is-three-quarters">
            <h1 class="title">Edit Program Statistic</h1>
            ...
            <form action="{{ route('admin.program-statistics.update', $programStatistic) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input @error('label') is-danger @enderror" type="text" name="label" 
                            placeholder="e.g., Active Programs, Total Beneficiaries" value="{{ old('label', $programStatistic->label) }}" required>
                    </div>
                    @error('label')
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input @error('value') is-danger @enderror" type="text" name="value" 
                            placeholder="e.g., 8, 250K+, ₱600M+" value="{{ old('value', $programStatistic->value) }}" required>
                    </div>
                    @error('value')
                        <p class="help is-danger">{{ $message }}</p>
                    @enderror
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input @error('icon') is-danger @enderror" type="text" name="icon" 
                            placeholder="e.g., fas fa-chart-bar, fas fa-users" value="{{ old('icon', $programStatistic->icon) }}">
                    </div>
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input @error('color') is-danger @enderror" type="text" name="color" 
                            placeholder="e.g., #667eea, #48c774" value="{{ old('color', $programStatistic->color) }}">
                    </div>
                    @error('color')
                        <p class="help is-danger">{{ $message }}</p>
                    @enderror
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input @error('background_class') is-danger @enderror" type="text" name="background_class" 
                            placeholder="e.g., has-background-success-light, has-background-info-light" value="{{ old('background_class', $programStatistic->background_class) }}">
                    </div>
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input @error('order') is-danger @enderror" type="number" name="order" 
                            placeholder="0" value="{{ old('order', $programStatistic->order) }}" required>
                    </div>
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <textarea class="textarea @error('description') is-danger @enderror" name="description" 
                            placeholder="Optional additional description" rows="3">{{ old('description', $programStatistic->description) }}</textarea>
                    </div>
                    @error('description')
                        <p class="help is-danger">{{ $message }}</p>
                    @enderror
                ...
                <div class="field">
                    <div class="control">
                        <label class="checkbox">
                            <input type="checkbox" name="is_active" value="1" {{ old('is_active', $programStatistic->is_active) ? 'checked' : '' }}>
                            <span>Active</span>
                        </label>
                    </div>
                </div>
